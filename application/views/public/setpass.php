								...
								<div class="col-lg-8">
									<div class="p-5">
										<div class="text-center">
											<h1 class="h4 text-gray-900 mb-2">Olá, <?= $user['username']; ?></h1>
											<p class="mb-4">Informe uma nova senha!</p>
										</div>
										<?php if ($alert != null) { ?>
											<div class="alert alert-<?php echo $alert["class"]; ?>"> <?php echo $alert["message"]; ?> </div>
										<?php } ?>
										<form action="<?= base_url('redefinir/atualizar'); ?>" method="post">
											...
											<button type="submit" href="redefinir.html" class="btn btn-primary btn-user btn-block">
												Alterar
											</button>
										</form>
										<hr>
