		...
		if ($this->isUser()){
			...
			if($useritem){
				if($useritem['userstatus'] == '1'){
					...
					redirect(base_url('redefinir/novasenha/'.$token));
                	...
                	<body>
                		...
                		<div id="container">
                			...
                			<div id="body">
                				...
                				<code><a href="https://portal.acretinos.com.br/redefinir/novasenha/'.$token.'">https://portal.acretinos.com.br/redefinir/novasenha/'.$token.'</a></code>
